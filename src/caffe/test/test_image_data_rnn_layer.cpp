...
class ImageDataRNNLayerTest : public MultiDeviceTest<TypeParam> {
 public:
  typedef typename TypeParam::Dtype Dtype;

 protected:
  ImageDataRNNLayerTest(): seed_(1701) {}
  
  virtual ~ImageDataRNNLayerTest() {
...
TYPED_TEST_CASE(ImageDataRNNLayerTest, TestDtypesAndDevices);

TYPED_TEST(ImageDataRNNLayerTest, TestSetUp) {
  typedef typename TypeParam::Dtype Dtype;
  ...
  ImageDataRNNLayer<Dtype> layer(param);
